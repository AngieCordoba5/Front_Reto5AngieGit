...
function pintarRespuestaCabin(response){
    ...
    myTable+="<tr>";
        ...
        myTable+='<td><button class = "botonCabin2" onclick="borrar(' + response[i].id + ')">Borrar Cabaña</button></td>';
        myTable+='<td><button class = "botonCabin2" onclick="cargarDatosCabin(' + response[i].id + ')">Editar Cabaña</button></td>';
        myTable+='<td><button class = "botonCabin2" onclick="actualizar(' + response[i].id + ')">Actualizar Cabaña</button></td>';
        myTable+="</tr>";
    }
    myTable+="</table>";
...
function cargarDatosCabin(id) {
    $.ajax({
        dataType: 'json',
        url:"http://129.151.118.90:8080/api/Cabin/"+id,
        type: 'GET',
